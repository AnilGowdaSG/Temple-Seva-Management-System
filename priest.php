...
<body>
    ...
    <div class="content">
        ...
        <div class="search-container">
            <input type="text" id="priestSearchInput" placeholder="Search by Priest Name">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p class='no-results'>No priests found.</p>";
        }
    ...
    <script>
        function searchPriest() {
            ...
            for (i = 1; i < tr.length; i++) {
                td = tr[i].getElementsByTagName("td")[1]; // Priest Name column
                if (td) {
